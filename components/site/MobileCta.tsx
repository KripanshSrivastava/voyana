  ...
  return (
    <div className="pb-safe fixed inset-x-0 bottom-0 z-40 border-t border-navy-100 bg-white/90 p-3 backdrop-blur-md md:hidden">
      {isHome ? (
        <button
          type="button"
          onClick={() => window.dispatchEvent(new Event("voyana:open-lead-modal"))}
          className="press flex h-12 w-full items-center justify-center gap-2 rounded-full bg-sun-500 text-base font-semibold text-white shadow-lg shadow-sun-500/25"
        >
